...
## Unstable dhcp leases.

The VM asks for new addresses when disk changes.
Currious.

The VM is supposed to have a stable MAC based on its uuid.
The expected behavior is for it to get the ip it were assigned before disk is changed.
