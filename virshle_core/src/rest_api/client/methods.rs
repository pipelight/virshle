...
pub struct Client {
    nodes: HashMap<Node, RestClient>,
}

impl VirshleMethods<'_> {
...
pub mod template {
    use super::*;
    use crate::rest_api::CreateVmArgs;
...
pub mod vm {
    use super::*;
    use crate::hypervisor::vmm::types::VmInfoResponse;
